...
class AWoL_MRF:
    ...
    def __init__(self, labelimg_list, brainimg, bbox=None, beta=-.2,
    ...
    def next_voxel(self):
        ...
        #increment the confidence level of all the neighbor low-confidence voxels
    ...
    def mrf_potentials(self):
        ...
        lflat[lcv] = self.label_values[np.argmax(self.label_count[lcv])] #this also updates self.new_labels
