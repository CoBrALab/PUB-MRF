...
class AWoL_MRF:
    ...
    def mrf_potentials(self):
        ...
        for value in self.patch_stats.keys(): #compute doubleton and singleton potentials
            ...
            mrf_double = self.beta*(2*np.sum(self.probability[np.where(self.label_values == value), n]) - len(n))
    ...
    def get_output_image(self):
        ...
        mode_arg = np.argmax(self.probability, axis=0).reshape(self.label_shape)
